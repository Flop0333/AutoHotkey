; ============================================================================
; === Secrets Example Class =====================================================
; ============================================================================
;
; [DESCRIPTION]
; This file is an example of the Secrets.ahk file where you can store your personal
; secret values. The Secrets.ahk file is ignored by git to keep your secrets private.
;
; [USAGE]
; To use this example, rename this file to 'Secrets.ahk' and fill in your own values.
; ============================================================================

#Include Secrets Service.ahk
#Include Secrets Base.ahk
