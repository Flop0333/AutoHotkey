...
| [AHK Tests](../.github/workflows/ahk-tests.yml) | Push or pull request targeting `main` | On `windows-latest`, validates documentation, then downloads AutoHotkey v2 and runs architecture, syntax, unit, and logging integration tests. Concurrent runs for the same ref cancel older ones. |
