...
; deviceName := "Rolfstone Focus Pro" ; Define the name of the Bluetooth device to connect to
deviceName := "Solix Nexus ANC" ; Define the name of the Bluetooth device to connect to
