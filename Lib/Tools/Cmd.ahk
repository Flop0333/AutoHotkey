...
; 	MsgBox c.StdOutOnly
;	c := ""  ; destroys object and frees console
;
; 	output := (Cmd()).Execute("echo Quick test").StdOutOnly
; 	MsgBox output
;
;	Cmd.RunWith("notepad.exe", "C:\Users\Ilerion\Documents\test text.txt")
; ============================================================================
