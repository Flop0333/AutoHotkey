; ; Create an instance of the WinHttpRequest class
; http := WinHttpRequest()

; ; Set the user agent, optional
; ; http.Option[http.Option.UserAgentString] := "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36"

; ; Define the URL with the desired code
; url := "https://http.dog/200.jpg"

; ; Perform the GET request
; responseText := http.request(url)

; ; Check the status of the response
; statusCode := http.Status
; statusText := http.StatusText

; ; Output the status code and text to verify the request was successful
; MsgBox "Status Code: " statusCode "`nStatus Text: " statusText "`nResponse: " responseText

; ; Since AutoHotkey does not directly display images, you would need to open this URL in a web browser or use GUI commands to display the image from the response.
