...
class JSON {
    ...
    static ToObject(jsonString, objectType := {}) {
	...
	static ToPlainObjectArray(objectArray) {
		plainObjects := []
		for object in objectArray
			plainObjects.Push(this.ToPlainObject(object))
		return plainObjects
	}
	
	static ToPlainObject(object) {
		plainObject := Map()
		for propName, propValue in object.OwnProps() 
			plainObject.Set(propName, propValue)
